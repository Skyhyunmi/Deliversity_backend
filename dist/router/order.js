...
exports.order.post('/', util.isLoggedin, function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            console.log("위치", reqBody.userLat, reqBody.userLng, reqBody.storeLat, reqBody.storeLng);
            if (fee > 0)
...
exports.order.delete('/', util.isLoggedin, util.isUser, function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        // 배달원이 해당 주문에 배달원 신청
        const tokenData = req.decoded;
        const reqBody = req.body;
        // 해당 주문 번호
        const order = yield models_1.orderRep.findOne({ where: { id: reqBody.orderId } });
        if (!order)
            return res.status(403).json(util.successFalse(null, "주문 건이 없습니다.", null));
        const orderStatus = parseInt(order.orderStatus);
        if (orderStatus != 0)
