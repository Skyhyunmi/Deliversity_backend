...
exports.admin.get('/uploads', util.isLoggedin, util.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // 민증 확인 리스트 반환
    try {
...
exports.admin.get('/upload', util.isLoggedin, util.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // 상세내용 반환
    const reqQuery = req.query;
    const id = parseInt(reqQuery.id, 10);
    try {
        const user = yield index_1.userRep.findOne({ where: { id } });
        if (!user) {
...
exports.admin.put('/upload', util.isLoggedin, util.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // 민증인증 처리
    const reqQuery = req.query;
    ...
    try {
        let user = yield index_1.userRep.findOne({ where: { id }, attributes: ['id', 'grade'] });
        if (!user) {
            return res.status(403).json(util.successFalse(null, '해당하는 유저가 없습니다.', null));
        }
        if (user.grade === 2) {
...
exports.admin.get('/reports', util.isLoggedin, util.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // 신고 리스트 반환
    try {
...
exports.admin.get('/report', util.isLoggedin, util.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // 신고 상세내용보기
    const reqQuery = req.query;
    const reportId = parseInt(reqQuery.reportId, 10);
    try {
...
exports.admin.put('/report', util.isLoggedin, util.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // 신고 답변 작성
    const reqQuery = req.query;
    const reqBody = req.body;
    const reportId = parseInt(reqQuery.reportId, 10);
    ...
    try {
        ...
        yield answered_report.update({ answer, status: true });
...
exports.admin.get('/qnas', util.isLoggedin, util.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // 문의 리스트 반환
    try {
...
exports.admin.get('/qna', util.isLoggedin, util.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // 문의 상세내용보기
    const reqQuery = req.query;
    const qnaId = parseInt(reqQuery.qnaId, 10);
    try {
...
exports.admin.put('/qna', util.isLoggedin, util.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // 문의 답변 작성
    const reqQuery = req.query;
    const reqBody = req.body;
    const qnaId = parseInt(reqQuery.qnaId, 10);
...
exports.admin.get('/refunds', util.isLoggedin, util.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // 환급 리스트 반환
    try {
...
exports.admin.get('/openToken', util.isLoggedin, util.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.admin.put('/refund', util.isLoggedin, util.isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // 환급 답변 작성
    const reqQuery = req.query;
    const reqBody = req.body;
    const refundId = parseInt(reqQuery.refundId, 10);
